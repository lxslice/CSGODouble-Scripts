...
function placeBet() {
    return "lastcolor" === lastRollColor ? ($lastcolorButton.click(), void(lastselection = "lastcolor")) : ($notlastcolorButton.click(), void(lastselection = "notlastcolor"))
}
...
function getColor(a) {
    return 0 == a ? "green" : a >= 1 && 7 >= a ? "lastcolor" : "notlastcolor"
}
...
var currentBetAmount = initialBetAmount,
    ...
    $lastcolorButton = $("#panel1-7 .betButton"),
    $notlastcolorButton = $("#panel8-14 .betButton"),
